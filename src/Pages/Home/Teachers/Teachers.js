...
import './Teachers.css'
import teacher1 from '../../../Images/taqi usmani.jpg'
import teacher1Cover from '../../../Images/taqi2.jpg'
                        ...
                        <div class="col-lg-12">
                            <div class="section-title text-center">
                                <div class="title-text mb50">
                                    <h2>All Teachers</h2>
                                    <h1>Interactive Teaching Our Online Platforms</h1>
                                </div>
                            </div>
                        </div>
                        {/* <!-- /col end--> */}
